package com.projetocodigo.projetoIbm;
...
public class AceitacaoTest {
  ...
  public void testOrganizarTimes() {
    var solucao = new TomasAvelino();

    // Caso de teste 1: Nenhum jogador
    List<String> jogadores1 = Arrays.asList();
    Map<String, List<String>> times1 = TomasAvelino.organizarTimes(jogadores1);
    ...
    Map<String, List<String>> times2 = TomasAvelino.organizarTimes(jogadores2);
...
//    Map<String, List<String>> times3 = TomasAvelino.organizarTimes(jogadores3);
//    assertEquals(3, times3.size(),
//        "Caso de teste 3: Um time com dois jogadores do mesmo sobrenome");

    // Caso de teste 4: Dois times com dois jogadores do mesmo sobrenome
//    List<String> jogadores4 = Arrays.asList("Lionel Messi", "Lucas Messi", "Cristiano Ronaldo",
//        "Carlos Ronaldo");
//    Map<String, List<String>> times4 = TomasAvelino.organizarTimes(jogadores4);
//    assertEquals(4, times4.size(),
//        "Caso de teste 4: Dois times com dois jogadores do mesmo sobrenome");

    // Caso de teste 5: Jogadores com sobrenomes diferentes e iguais em letras diferentes
//    List<String> jogadores5 = Arrays.asList("Lionel Messi", "Lucas Messi", "Cristiano Ronaldo",
//        "Carlos Ronaldo", "Neymar Jr.");
//    Map<String, List<String>> times5 = TomasAvelino.organizarTimes(jogadores5);
...
//    Map<String, List<String>> times6 = TomasAvelino.organizarTimes(jogadores6);
...
//    List<String> jogadores7 = Arrays.asList("Lionel Messi", "lucas messi", "Cristiano Ronaldo",
//        "carlos Ronaldo", "Neymar Jr.");
//    Map<String, List<String>> times7 = TomasAvelino.organizarTimes(jogadores7);
//    assertEquals(5, times7.size(),
//        "Caso de teste 7: Nomes com letras maiúsculas e minúsculas misturadas");
//
//    // Caso de teste 8: Nomes com acentos
//    List<String> jogadores8 = Arrays.asList("José Silva", "João Sá", "Maria Alves",
//        "Ângela Pereira");
//    Map<String, List<String>> times8 = TomasAvelino.organizarTimes(jogadores8);
...
//    List<String> jogadores10 = Arrays.asList("Lionel Messi", "Cristiano Ronaldo", "Neymar Jr.",
//        "123ABC Adams", "1st Place");
//    Map<String, List<String>> times10 = TomasAvelino.organizarTimes(jogadores10);
//    assertEquals(5, times10.size(),
//        "Caso de teste 10: Jogadores com sobrenomes iniciados por números");
  }
